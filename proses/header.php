...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-5">
        <a class="navbar-brand" href="index.php"><i class="fas person"></i> Home </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                if(empty($_SESSION['sesi'])){
                    ...
                    echo '
                    <li class="nav-item">
                        <a class="nav-link" href="pengguna.php">Akun <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="siswa_seleksi.php">Siswa Seleksi</a>
                    ...
                    echo '
                    <li class="nav-item">
                    <a class="nav-link" href="pernyataan.php">Pernyataan</a>
                </li>

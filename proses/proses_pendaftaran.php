...
$query = mysqli_query($db,"insert into pendaftaran 
 ...
 nama_ayah,nik_ayah,tahun_lahir_ayah,pendidikan_ayah,pernah_pondok_ayah,pesantren_ayah,pekerjaan_ayah,penghasilan_ayah,nama_ibu,nik_ibu,tahun_lahir_ibu,pendidikan_ibu,pernah_pondok_ibu,pesantren_ibu,pekerjaan_ibu,penghasilan_ibu,tanggal) 
 ...
 '$ayah','$nikayah','$ttlayah','$penayah','$mondokayah','$alumayah','$kerjaayah','$hasilayah','$ibu','$nikibu','$ttlibu','$penibu','$mondokibu','$alumibu','$kerjaibu','$hasilibu','$currentDate2')");
     // memasukkan data inputan ke tabel pendaftaran
